...
public class CustomBow extends BowItem {
    ...
    public CustomBow(Item.Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ...
            if (itemStack.getItem() instanceof CustomArrow) {
                CustomArrow arrowItem = (CustomArrow)(itemStack.getItem());
                persistentProjectileEntity = arrowItem.createArrow(world, itemStack, playerEntity);
            }
            else if (itemStack.getItem() instanceof ArrowItem){
    ...
    public Predicate<ItemStack> getProjectiles() {
        return BOW_PROJECTILES.or(stack -> stack.isOf(RegisterItems.CUSTOM_ARROW));
    }
